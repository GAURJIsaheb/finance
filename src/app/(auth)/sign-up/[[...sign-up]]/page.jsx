...
export default function Page() {
  return (
    ...
    >
      ...
      <h1 className="flex text-4xl  items-center justify-center font-extrabold leading-none tracking-tight text-gray-100 md:text-3xl lg:text-4xl mt-12 dark:text-white">Sign  Up !</h1>
      ...
      {/* Content */}
      <motion.div
        className="relative z-10 flex flex-col items-center justify-center bg-white/10 mt-[20vh] mb-16 rounded-lg backdrop-blur-xl border border-gray-300 shadow-xl w-[250px]"
        initial={{ scale: 0.9 }}
        animate={{ scale: 1 }}
